...
|:---:|:---:|---|:---:|---|
| 9.5.4 | latest<br />9<br />9.5 | atomik_blank | 8.2 | `ghcr.io/concrete5-community/docker5:9.5.4`<br />`ghcr.io/concrete5-community/docker5:latest`<br />`ghcr.io/concrete5-community/docker5:9`<br />`ghcr.io/concrete5-community/docker5:9.5` |
| 9.5.4-full | latest-full<br />9-full<br />9.5-full | atomik_full | 8.2 | `ghcr.io/concrete5-community/docker5:9.5.4-full`<br />`ghcr.io/concrete5-community/docker5:latest-full`<br />`ghcr.io/concrete5-community/docker5:9-full`<br />`ghcr.io/concrete5-community/docker5:9.5-full` |
| 9.5.3 |  | atomik_blank | 8.2 | `ghcr.io/concrete5-community/docker5:9.5.3` |
| 9.5.3-full |  | atomik_full | 8.2 | `ghcr.io/concrete5-community/docker5:9.5.3-full` |
| 9.5.2 |  | atomik_blank | 8.2 | `ghcr.io/concrete5-community/docker5:9.5.2` |
| 9.5.2-full |  | atomik_full | 8.2 | `ghcr.io/concrete5-community/docker5:9.5.2-full` |
...
| 9.4.8-full | 9.4-full | atomik_full | 8.2 | `ghcr.io/concrete5-community/docker5:9.4.8-full`<br />`ghcr.io/concrete5-community/docker5:9.4-full` |
| 9.4.7 |  | atomik_blank | 8.2 | `ghcr.io/concrete5-community/docker5:9.4.7` |
| 9.4.7-full |  | atomik_full | 8.2 | `ghcr.io/concrete5-community/docker5:9.4.7-full` |
| 9.4.6 |  | atomik_blank | 8.2 | `ghcr.io/concrete5-community/docker5:9.4.6` |
| 9.4.6-full |  | atomik_full | 8.2 | `ghcr.io/concrete5-community/docker5:9.4.6-full` |
| 9.4.5 |  | atomik_blank | 8.2 | `ghcr.io/concrete5-community/docker5:9.4.5` |
| 9.4.5-full |  | atomik_full | 8.2 | `ghcr.io/concrete5-community/docker5:9.4.5-full` |
| 9.4.4 |  | atomik_blank | 8.2 | `ghcr.io/concrete5-community/docker5:9.4.4` |
| 9.4.4-full |  | atomik_full | 8.2 | `ghcr.io/concrete5-community/docker5:9.4.4-full` |
| 9.4.3 |  | atomik_blank | 8.2 | `ghcr.io/concrete5-community/docker5:9.4.3` |
| 9.4.3-full |  | atomik_full | 8.2 | `ghcr.io/concrete5-community/docker5:9.4.3-full` |
...
| 9.4.0-full |  | atomik_full | 8.2 | `ghcr.io/concrete5-community/docker5:9.4.0-full` |
| 9.3.9 | 9.3 | atomik_blank | 8.2 | `ghcr.io/concrete5-community/docker5:9.3.9`<br />`ghcr.io/concrete5-community/docker5:9.3` |
| 9.3.9-full | 9.3-full | atomik_full | 8.2 | `ghcr.io/concrete5-community/docker5:9.3.9-full`<br />`ghcr.io/concrete5-community/docker5:9.3-full` |
...
| 5.7.5.13 | 5.7<br />5.7.5 | elemental_blank | 5.6 | `ghcr.io/concrete5-community/docker5:5.7.5.13`<br />`ghcr.io/concrete5-community/docker5:5.7`<br />`ghcr.io/concrete5-community/docker5:5.7.5` |
| 5.7.5.13-full | 5.7-full<br />5.7.5-full | elemental_full | 5.6 | `ghcr.io/concrete5-community/docker5:5.7.5.13-full`<br />`ghcr.io/concrete5-community/docker5:5.7-full`<br />`ghcr.io/concrete5-community/docker5:5.7.5-full` |
